...
with open("data/dev/sub_sampled_bird_dev_set_raw.json", "r") as file:
...
sizes = {
    'simple': int(0.45 * sample_size),
    'moderate': int(0.45 * sample_size),
}
...
with open("data/dev/ca_school.json", "w+") as file:
